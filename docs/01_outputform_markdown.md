...
아래 [내용]을 사례별로 목록화해줘. -출력 조건: 각 사례별로 대상분야, 핵심내용, 계약조건 요약
...
**대상분야:** 에너지·유틸리티 (발전설비 예지보전, 에너지 수요예측, 신재생 통합관리)

### 🔹 핵심내용
- **Smart Energy AI Platform** 구축 제안  
- 설비 예지보전: 비계획정지 **71% 감소**, 정비비 **₩112억 절감**  
- 수요예측 AI: 예측오차 **42% 개선**, 예비력·연료비 **₩730억 절감**  
- 신재생 통합관리: 출력예측 정확도 **+15%p**, ESS 수익 **₩120억 증가**  
- 디지털 트윈으로 가상 시운전·What-If 분석 지원  
- **ROI 23.5배**, **회수기간 5.1개월**, CO₂ 연간 20만 톤 감축  

### 🔹 계약조건 요약
| 구분 | 금액 | 기간 |
|------|------|------|
| Phase 1 – 예지보전 | ₩1.8B | 12개월 |
| Phase 2 – 수요예측 | ₩0.9B | 8개월 |
| Phase 3 – 신재생 통합 | ₩1.2B | 10개월 |
| Phase 4 – 디지털 트윈 | ₩1.1B | 12개월 |
| **총 투자비** | **₩5.0B / 42개월** | |
> 📅 1단계 PoC(당진화력 1호기) 2주 내 시연 예정  
---
